...
class ARSetWithCustomAssociationProviderTest < TransactionalTestCase
  ...
  def setup
    @provider = ARSetWithCustomAssociationProvider.new
    define_sets
  end
...
class ActiveRecordSetCachingResumptionProviderTest < TransactionalTestCase
  ...
  def setup
    @provider = CachingSetResumptionProvider.new
    define_sets
  end
...
class ActiveRecordSetCachingWithCustomAssociationProviderTest < TransactionalTestCase
  ...
  def setup
    @provider = CachingSetResumptionWithCustomAssociationProvider.new
    define_sets
  end
